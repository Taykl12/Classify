...
This application is a school management platform.
...
Users may spend several hours per day using the platform.
...
Avoid startup marketing aesthetics.
...
Use a professional institutional identity.
...
The interface should feel trustworthy and organized.
...
Avoid extremely dark layouts.

Default to light mode.

Dark mode is optional and secondary.
...
Users may have varying technical skills.

Interfaces must be understandable without training.

When uncertain:

* Prefer clarity over aesthetics.
* Prefer simplicity over novelty.
* Prefer readability over visual density.
...
The application is an operational tool.

Prefer showing useful information over oversized decorative layouts.

Avoid excessive whitespace that reduces information visibility.
