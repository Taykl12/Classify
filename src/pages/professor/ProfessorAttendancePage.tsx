    ...
    <DashboardLayout>
      <header className="admin-hero">
        ...
        <div>
          ...
          <h1 className="admin-hero__title">Asistencia</h1>
        </div>
      </header>
              ...
              <tbody>
                {visibleCourses.map((course) => (
                  <tr key={course.id}>
                    ...
                    <td className="projects-table__cell projects-table__cell--actions" data-label="Historial">
                      <Link
                        to={ROUTES.professorAttendanceCourse(course.id)}
